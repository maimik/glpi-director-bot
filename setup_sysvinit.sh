...
cat > /etc/init.d/director-bot << 'EOF'
#!/bin/bash
### BEGIN INIT INFO
...
DAEMON="/home/maimik/Projects/director/venv/bin/python3"
DAEMON_ARGS="bot.py"
WORK_DIR="/home/maimik/Projects/director"
PID_FILE="/var/run/director-bot.pid"
LOG_FILE="/home/maimik/Projects/director/logs/service.log"
RUN_USER="maimik"
...
echo "Logs: tail -f /home/maimik/Projects/director/logs/service.log"
